...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	// Create
	'UI:Links:Create:Button'                        => '新建',
	'UI:Links:Create:Button+'                       => '新建 %4$s',
	'UI:Links:Create:Modal:Title'                   => '新建 %4$s 至 %2$s',

	// Add
	'UI:Links:Add:Button'                           => '添加',
	'UI:Links:Add:Button+'                          => '添加 %4$s',
	'UI:Links:Add:Modal:Title'                      => '添加 %4$s 至 %2$s',

	// Modify link
	'UI:Links:ModifyLink:Button'                    => '修改',
	'UI:Links:ModifyLink:Button+'                   => '修改这个链接',
	'UI:Links:ModifyLink:Modal:Title'               => '修改 %2$s 与 %5$s 之间的链接',
	...
	'UI:Links:Remove:Modal:Message'                 => '请确认从 %2$s 中移除 %5$s ?',
