...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'UI:Audit:ErrorIn_Rule_Reason'              => '%1$s 中发现 OQL 错误: %2$s.',
	'UI:Audit:ErrorIn_Category'                 => '类别中有错误',
	'UI:Audit:ErrorIn_Category_Reason'          => '%1$s 中发现 OQL 错误: %2$s.',
	...
	'UI:Audit:AuditCategory:Subtitle'           => '%2$s 个中有 %1$s 个错误 - 有效的对象为 %3$s%%',
