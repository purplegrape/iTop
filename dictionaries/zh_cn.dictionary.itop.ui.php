...
它集中了作用于特定范围内对象的所有审计规则',
	...
	'Class:AuditCategory/Attribute:domains_list+'            => '此类别相关的审计域列表',
]);
...
审计域通常对应负责检查和修复错误的人或团队',
	...
	'Class:AuditDomain/Attribute:categories_list+' => '此类别相关的审计类别',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:lnkAuditCategoryToAuditDomain' => '链接 审计类别/审计域',
	'Class:lnkAuditCategoryToAuditDomain+' => '',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'UI:Button:SearchInHierarchy'    => '在架构中搜索',
	'UI:Button:Query'                => ' 查询 ',
	'UI:Button:Ok'                   => 'OK',
	'UI:Button:Save'                 => '保存',
	...
	'UI:Error:MandatoryTemplateParameter_object_id'      => '当 link_attr 被指定时, 参数 object_id 是必须的. 请检查显示模板的定义.',
	'UI:Error:MandatoryTemplateParameter_target_attr'    => '当 link_attr 被指定时, 参数 target_attr 是必须的. 请检查显示模板的定义.',
	'UI:Error:MandatoryTemplateParameter_group_by'       => '参数 group_by 是必须的. 请检查显示模板的定义.',
	'UI:Error:InvalidGroupByFields'                      => '分组字段列表是无效的: "%1$s".',
	'UI:Error:UnsupportedStyleOfBlock'                   => '报错: 不被支持的 block 格式: "%1$s".',
	'UI:Error:IncorrectLinkDefinition_LinkedClass_Class' => '链接定义不正确: 关联的对象: %1$s 不是 %2$s 的外键',
	'UI:Error:Object_Class_Id_NotFound'                  => '对象: %1$s:%2$d找不到.',
	'UI:Error:WizardCircularReferenceInDependencies'     => '报错: 字段之间的依赖性出现循环引用, 请检查数据模型.',
	'UI:Error:UploadedFileTooBig'                        => '上传文件太大. (允许的最大限制是 %1$s). 请检查 PHP 配置文件中的 upload_max_filesize和post_max_size.',
	...
	'UI:Error:1ParametersMissing'                         => '报错: 必须为此操作指定以下参数: %1$s.',
	'UI:Error:2ParametersMissing'                         => '报错: 必须为此操作指定以下参数: %1$s和%2$s.',
	'UI:Error:3ParametersMissing'                         => '报错: 必须为此操作指定以下参数: %1$s, %2$s和%3$s.',
	'UI:Error:4ParametersMissing'                         => '报错: 必须为此操作指定以下参数: %1$s, %2$s, %3$s和%4$s.',
	'UI:Error:IncorrectOQLQuery_Message'                  => '报错: 错误的OQL查询: %1$s',
	'UI:Error:AnErrorOccuredWhileRunningTheQuery_Message' => '运行此查询时发生了一个报错: %1$s',
	'UI:Error:ObjectAlreadyUpdated'                       => '报错: 此对象已更新.',
	'UI:Error:ObjectCannotBeUpdated'                      => '报错: 对象无法更新.',
	'UI:Error:ObjectsAlreadyDeleted'                      => '报错: 对象已被删除!',
	...
	'UI:Error:ObjectAlreadyCloned'                        => '报错: 此对象已被克隆!',
	'UI:Error:ObjectAlreadyCreated'                       => '报错: 此对象已被创建!',
	'UI:Error:Invalid_Stimulus_On_Object_In_State'        => '报错: 在对象 %2$s 的 "%3$s" 状态上的无效调整 "%1$s".',
	'UI:Error:InvalidDashboardFile'                       => '报错: 无效的仪表盘文件',
	'UI:Error:InvalidDashboard'                           => '报错: 无效的仪表盘',
	...
	'UI:SelectOne' => '-- 请选择 --',
	'UI:AccessRO-All'                              => ITOP_APPLICATION.' 处于只读状态',
	...
	'UI:CSVImport:ErrorOnlyOneColumn'              => '报错: 数据仅包含一列. 您选择了合适的分隔符了吗?',
	...
	'UI:CSVImport:ErrorExtendedAttCode'            => '内部报错: "%1$s" 是错误的编码, 因为 "%2$s" 不是类型 "%3$s" 的外键',
	'UI:CSVImport:ObjectsWillStayUnchanged'        => '%1$d个对象保持不变.',
	'UI:CSVImport:ObjectsWillBeModified'           => '%1$d个对象将会被修改.',
	'UI:CSVImport:ObjectsWillBeAdded' => '%1$d个对象将会被添加.',
	'UI:CSVImport:ObjectsWillHaveErrors' => '%1$d个对象将会发生错误.',
	...
	'UI:UniversalSearch:Error'                => '报错: %1$s',
	...
	'UI:CSVReport-Row-Issue-Internal'           => '内部报错: %1$s, %2$s',
	...
	'UI:CSVReport-Icon-Missing'           => '缺失',
	'UI:CSVReport-Object-MissingToUpdate' => '缺失对象: 将要更新',
	'UI:CSVReport-Object-MissingUpdated'  => '缺失对象: 已更新',
	'UI:CSVReport-Icon-Created'           => '创建',
	'UI:CSVReport-Object-ToCreate'        => '将要创建的对象',
	'UI:CSVReport-Object-Created'         => '已创建的对象',
	'UI:CSVReport-Icon-Error'             => '错误',
	'UI:CSVReport-Object-Error'           => '报错: %1$s',
	...
	'UI:Audit:Interactive:Categories:Title'       => '%1$s 的审计结果',
	'UI:Audit:Interactive:Categories:SubTitle'    => '%1$s 类别下所有规则的审计结果',
	'UI:Audit:Interactive:Categories:BreadCrumb'  => '类别',
	'UI:Audit:Interactive:Categories:BreadCrumb+' => '审计类别: %1$s',
	'UI:Audit:Interactive:Domain:Title' 	  	  => '审计域: %1$s 的审计结果',
	'UI:Audit:Interactive:Domain:SubTitle'        => '%1$s 审计域之下所有审计规则的审计结果',
	...
	'UI:Audit:Interactive:Selection:SubTitle'     => '请选择一个审计域并把结果限定在该审计域内或者选择 "所有类别" 进行全量审计 (要审计的数据太大可能导致耗时较长甚至失败)',
	'UI:Audit:Interactive:Selection:BreadCrumb'   => '请选择',
	'UI:Audit:Interactive:Selection:BreadCrumb+'  => '请选择要执行的审计',
	...
	'UI:Audit:ErrorIn_Rule'                     => '规则中发现错误',
	'UI:Audit:ErrorIn_Rule_Reason'              => '%1$s 中发现 OQL 报错: %2$s.',
	'UI:Audit:ErrorIn_Category'                 => '类别中有错误',
	'UI:Audit:ErrorIn_Category_Reason'          => '%1$s 中发现 OQL 报错: %2$s.',
	...
	'UI:Audit:AuditCategory:Subtitle'           => '%2$s 个对象中有 %1$s 个报错 - 对象的有效率为 %3$s%%',
	...
	'UI:Schema:LifeCycleAttributeMustPrompt' => '用户将会被提示修改',
	...
	'UI:LinksWidget:Autocomplete+' => '请输入前3个字符...',
	...
	'UI:RemoveLinkedObjectsOf_Class' => '移除已选择的对象',
	...
	'UI:Delete:WillBeDeletedAutomatically' => '将会被自动删除',
	'UI:Delete:MustBeDeletedManually' => '必须手动删除',
	'UI:Delete:CannotUpdateBecause_Issue' => '应该被自动更新, 但是: %1$s',
	'UI:Delete:WillAutomaticallyUpdate_Fields' => '将会被自动更新 (重置: %1$s)',
	...
	'UI:SelectTheTypeOf_Class_ToCreate' => '请选择 %1$s 的类型:',
	...
	'UI-RequestManagementOverview-RequestUnassigned' => '尚未分配给办理人的需求',
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'UI:TagSetFieldData:Error' => '报错: %1$s',
	...
	'Portal:ErrorNoContactForThisUser' => '报错: 当前用户没有与任何联系人关联. 请联系管理员.',
	...
	'UI:Favorites:Default_X_ItemsPerPage' => '默认行数: 每页 %1$s 项',
	...
	'UI:Display_X_ItemsPerPage_suffix' => '项',
	...
	'UI:DashletCreation:DashletType' => '仪表类型',
	...
	'UI:DashboardEdit:Dashlets' => '可用的仪表',
	'UI:DashboardEdit:DashletProperties' => '仪表属性',
	...
	'UI:DashletProxy:Description' => '代理仪表',
	...
	'UI:DashletGroupBy:Prop-GroupBy:Select-Year' => '%1$s (年)',
	...
	'UI:CSVImportError_items' => '报错: %1$d',
...
<tr><td>s</td><td>秒 (2位数, 比如 00..59)</td></tr>
	...
	'portal:backoffice' => ITOP_APPLICATION_SHORT.' 后台管理界面',
	...
	'UI:Search:Value:Toggler:CheckAllNone' => '全选/全不选',
	'UI:Search:Value:Toggler:CheckAllNoneFiltered' => '全选/全不选',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Menu:UniversalSearchMenu+'     => '搜索任何类型的对象,包括抽象类',
