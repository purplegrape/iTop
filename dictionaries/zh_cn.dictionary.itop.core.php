...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Core:UniquenessDefaultError' => '唯一性规则 \'%1$s\' 报错',
	...
	'Core:AttributeEncryptFailedToDecrypt' => '** 解密报错 **',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:CMDBChangeOp+' => '记录某人某天对某个对象的变更操作',
	...
	'Class:CMDBChangeOp/Attribute:objclass+' => '发生变更的对象类型',
	'Class:CMDBChangeOp/Attribute:objkey' => '对象id',
	'Class:CMDBChangeOp/Attribute:objkey+' => '发生变更的对象id',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EventWebService/Attribute:log_warning+' => '告警日志的结果',
	'Class:EventWebService/Attribute:log_error' => '报错日志',
	'Class:EventWebService/Attribute:log_error+' => '报错日志的结果',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Core:EventNotificationNewsroom:ErrorOnDBInsert' => '保存通知时发生报错',
]);
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:SynchroDataSource/Attribute:notify_contact_id+'                          => '发生报错时将要通知的联系人',
...
"value" 必须是该字段的授权值.',
	...
	'Class:SynchroDataSource/Attribute:delete_policy+'                              => '副本废弃后要进行的操作:
"忽略": 无操作, 关联对象保持原值.
...
"更新并删除": 应用 "更新规则". 当达到保留期限后执行 "删除"',
	...
	'Core:Synchro:Nb_Replica'                                                  => '已处理的副本: %1$s',
	...
	'Core:SynchroAtt:reconciliation_attcode'                                   => '调和键',
	'Core:SynchroAtt:reconciliation_attcode+'                                  => '调和外部键的属性编码',
	...
	'Core:Synchro:ListReplicas_AllReplicas_Errors_Warnings'                    => '%1$s个副本, %2$s个报错, %3$s个告警.',
	...
	'Class:SynchroAttribute/Attribute:update_policy/Value:write_if_empty'      => '初始化为空',
	'Class:SynchroAttribute/Attribute:finalclass'                              => '类',
	'Class:SynchroAttExtKey'                                                   => '同步属性 (外键)',
	'Class:SynchroAttExtKey/Attribute:reconciliation_attcode'                  => '调整属性',
	...
	'Class:SynchroLog/Attribute:stats_nb_replica_seen'                  => '可见的副本数量',
	'Class:SynchroLog/Attribute:stats_nb_replica_total'                 => '副本总数',
	'Class:SynchroLog/Attribute:stats_nb_obj_deleted'                   => '已删除对象数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_deleted_errors'            => '删除时的错误数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_obsoleted'                 => '已废弃对象数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_obsoleted_errors'          => '废弃时的错误数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_created'                   => '已创建对象数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_created_errors'            => '创建时的错误数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_updated'                   => '已更新对象数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_updated_errors'            => '更新时的错误数量',
	'Class:SynchroLog/Attribute:stats_nb_replica_reconciled_errors'     => '复制时的错误数量',
	'Class:SynchroLog/Attribute:stats_nb_replica_disappeared_no_action' => '已消失的副本数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_new_updated'               => '已更新的对象数量',
	'Class:SynchroLog/Attribute:stats_nb_obj_new_unchanged'             => '未更改的对象数量',
	'Class:SynchroLog/Attribute:last_error'                             => '最新报错',
	...
	'Core:ExecProcess:Code255'                       => 'PHP 报错 (解析, 或运行时)',
	...
	'Core:Validator:MustSelectOne' => '请至少选择一项',
]);
