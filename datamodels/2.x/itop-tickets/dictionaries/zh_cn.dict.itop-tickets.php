...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Ticket/Attribute:contacts_list+' => '此工单相关的联系人',
	'Class:Ticket/Attribute:functionalcis_list' => '配置项',
	'Class:Ticket/Attribute:functionalcis_list+' => '此工单相关的配置项. 标记为 "Computed" 的项目已自动标记为受影响. 标记为 "Not impacted" 的项目则从影响范围内排除.',
	'Class:Ticket/Attribute:workorders_list' => '工作任务',
	'Class:Ticket/Attribute:workorders_list+' => '此工单相关的工作任务',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:cmdbAbstractObject/Method:SetCurrentUser/Param:1+'       => '当前对象中要设置的字段. 如果此字段为字符串则使用昵称, 否则将使用标识符. 昵称为关联用户的名称, 否则会使用登录名.',
