...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Menu:iTopHub:Register+' => '进入 iTop Hub 以更新您的 '.ITOP_APPLICATION_SHORT.' 实例',
	'Menu:iTopHub:Register:Description' => '<p>进入 iTop Hub 社区平台!</br>寻找您想要的内容和信息, 管理本机扩展或安装新的扩展.</br><br/>通过这个页面连接到 iTop Hub, 本机的信息也会被推送到 iTop Hub 上.</p>',
	...
	'Menu:iTopHub:BrowseExtensions:Description' => '<p>进入 iTop Hub 商店, 一站式查找各种 iTop 扩展的地方 !</br>寻找符合您要求的扩展.</br><br/>通过这个页面连接到 iTop Hub, 本机的信息也会被推送到 iTop Hub 上.</p>',
	'iTopHub:GoBtn' => '进入 iTop Hub',
	'iTopHub:CloseBtn' => '关闭',
	'iTopHub:GoBtn:Tooltip' => '跳转到 www.itophub.io',
	...
	'iTopHub:NoExtensionInThisCategory+' => '浏览 iTop Hub, 去寻找符合您偏好的扩展吧.',
	'iTopHub:ExtensionNotInstalled' => '尚未安装',
