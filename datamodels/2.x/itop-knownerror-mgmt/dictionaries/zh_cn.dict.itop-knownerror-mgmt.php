...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:KnownError/Attribute:name+' => '此名称将作为此组织内的已知问题的唯一标识符',
	'Class:KnownError/Attribute:org_id' => '客户',
	'Class:KnownError/Attribute:org_id+' => '将已知问题关联至负责处理此问题的服务提供商. 若问题仅针对特定客户, 则也可关联至对应的客户组织',
	...
	'Class:KnownError/Attribute:symptom+' => '此错误的可见的影响是什么？',
	'Class:KnownError/Attribute:root_cause' => '问题根源',
	'Class:KnownError/Attribute:root_cause+' => '此错误的底层原因是什么？',
	'Class:KnownError/Attribute:workaround' => '解决过程',
	'Class:KnownError/Attribute:workaround+' => '如何规避此错误的影响直至找到适当的解决方案？',
	'Class:KnownError/Attribute:solution' => '解决方案',
	'Class:KnownError/Attribute:solution+' => '此错误的永久解决方案是什么？',
	'Class:KnownError/Attribute:error_code' => '错误码',
	'Class:KnownError/Attribute:error_code+' => '如果此已知错误关联到特定的错误码, 请在此指定',
	'Class:KnownError/Attribute:domain' => '领域',
	'Class:KnownError/Attribute:domain+' => '请选择此错误相关的技术领域',
	...
	'Class:KnownError/Attribute:ci_list+' => '这个已知错误相关的配置项',
	'Class:KnownError/Attribute:document_list' => '文档',
	'Class:KnownError/Attribute:document_list+' => '这个已知错误相关的文档',
]);
