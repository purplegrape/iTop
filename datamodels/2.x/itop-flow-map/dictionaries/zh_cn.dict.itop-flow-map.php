...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:FunctionalCI/Attribute:dataflows+' => '此对象作为源或目标的数据流',
	...
	'Class:DataFlow/Attribute:source_impact/Value:yes+' => '如果数据源失效, 数据流将会受到影响',
	...
	'Class:DataFlow/Attribute:destination_impact/Value:yes+' => '如果数据流停止, 目标将会受到影响',
	...
	'Class:DataFlow/Attribute:dataflowprotocol_id+' => '在数据流协议类型中定义的值',
	'Class:DataFlow/Attribute:documentation_url' => '文档 URL',
	'Class:DataFlow/Attribute:documentation_url+' => '数据流文档的 URL',
	'Class:DataFlow/Attribute:last_change_date' => '最后修改时间',
	'Class:DataFlow/Attribute:last_change_date+' => '数据流软件或配置最后更新的时间',
	...
	'Class:DataFlow/Attribute:execution_frequency/Value:ondemand+' => '立即执行,不按计划进行',
