...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'DBTools:Indication' => '重要提示: 修复数据库报错后, 可能会出现新的不一致, 您必须重新运行一次分析.',
	...
	'DBTools:ShowAll' => '显示报错',

	'DBTools:Inconsistencies' => '数据库不一致',
	'DBTools:DetailedErrorTitle' => '在 %1$s 中有 %2$s 个报错: %3$s',
	'DBTools:DetailedErrorLimit' => '列表中仅显示 %1$s 个报错',
