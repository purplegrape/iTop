...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Location/Attribute:address+' => '通讯地址',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Contact/Attribute:notify+' => '可供通知使用的标志位',
...
其他用途：用户请求的发起者为人员，被指派处理该请求的坐席同样为人员。~~',
	...
	'Class:Person/UniquenessRule:employee_number+' => '同一组织内的工号必须唯一',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:DocumentWeb+' => '指向外部应用程序或文档的超链接, 充当对外部资源的指针. 您无法从 '.ITOP_APPLICATION_SHORT.' 中搜索其内容',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:lnkPersonToTeam/Attribute:role_id+' => '在可能的角色类型中进行选择',
