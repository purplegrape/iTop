...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:Change/Attribute:status/Value:monitored' => '已监督',
	...
	'Class:Change/Attribute:related_request_list+' => '此变更相关需求',
	...
	'Class:Change/Stimulus:ev_monitor' => '监督',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:RoutineChange+' => '低风险的标准变更, 无需额外授权, 存在已验证过的流程且必须执行.',
	'Class:RoutineChange/Stimulus:ev_validate' => '验证',
	...
	'Class:RoutineChange/Stimulus:ev_monitor' => '监督',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	'Class:ApprovedChange' => '待审批的变更',
	'Class:ApprovedChange+' => '抽象类. 需要审批的正常变更和紧急变更.',
	...
	'Class:ApprovedChange/Stimulus:ev_monitor' => '监督',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:NormalChange/Stimulus:ev_monitor' => '监督',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:EmergencyChange+' => '用于处理紧急情况(重大故障、安全事件)的变更工单. 审批流程将会加速, 且会尽快实施.',
	'Class:EmergencyChange/Stimulus:ev_validate' => '验证',
	...
	'Class:EmergencyChange/Stimulus:ev_monitor' => '监督',
