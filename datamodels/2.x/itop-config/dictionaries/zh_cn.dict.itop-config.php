...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'config-cancel' => '重置',
	'config-saved' => '保存成功.',
	'config-confirm-cancel' => '您的修改将会被丢弃.',
	'config-no-change' => '没有变化: 配置文件将会保持不变.',
	'config-reverted' => '配置文件已恢复.',
	'config-parse-error' => '第%2$d行: %1$s.<br/>配置文件尚未更新.',
	'config-current-line' => '正在编辑: 第 %1$s 行',
	'config-saved-warning-db-password' => '保存成功, 但因为数据库密码中包含不支持的字符, 配置文件备份不会成功.',
	'config-error-transaction' => '报错: 无效的事务编号. 配置<b>没有</b>被更新.',
	'config-error-file-changed' => '报错: 配置文件在您打开以后已被更改, 无法保存. 请刷新并再次保存.',
