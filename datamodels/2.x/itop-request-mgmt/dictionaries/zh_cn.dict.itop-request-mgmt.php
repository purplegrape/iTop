...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Menu:UserRequest:MyWorkOrders+' => '分配给我的工单',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:UserRequest/Attribute:priority+' => '工单需要按什么顺序处理',
	...
	'Class:UserRequest/Attribute:urgency+' => '故障需要以多快的速度解决',
	'Class:UserRequest/Attribute:urgency/Value:1' => '紧急',
	'Class:UserRequest/Attribute:urgency/Value:1+' => '最紧急',
	...
	'Class:UserRequest/Attribute:urgency/Value:4+' => '最低紧急度',
	'Class:UserRequest/Attribute:origin' => '来源',
	'Class:UserRequest/Attribute:origin+' => '工单创建由什么触发',
	'Class:UserRequest/Attribute:origin/Value:in_person' => '当面沟通',
	'Class:UserRequest/Attribute:origin/Value:in_person+' => '源自面对面沟通',
	'Class:UserRequest/Attribute:origin/Value:chat' => '聊天工具',
	'Class:UserRequest/Attribute:origin/Value:chat+' => '源自聊天工具沟通',
	'Class:UserRequest/Attribute:origin/Value:mail' => '邮件',
	'Class:UserRequest/Attribute:origin/Value:mail+' => '源自邮件沟通',
	'Class:UserRequest/Attribute:origin/Value:monitoring' => '监控',
	'Class:UserRequest/Attribute:origin/Value:monitoring+' => '源自监控报警触发的事件',
	...
	'Class:UserRequest/Attribute:origin/Value:portal+' => '源自用户门户中新建的工单',
	...
	'Class:UserRequest/Attribute:escalation_flag+' => '如果设置, 该工单将会被添加到 "待升级" 菜单',
	...
	'Class:UserRequest/Attribute:time_spent' => '解决耗时',
	'Class:UserRequest/Attribute:time_spent+' => '',
	'Class:UserRequest/Attribute:resolution_code' => '解决方式',
	'Class:UserRequest/Attribute:resolution_code+' => '为了解决需求而做了哪些事情？',
